    ...
    if($method == "GET"){
        ...
        if (!isset($_GET["id"])){
            ...
            try {
                ...
                $sql = "SELECT n.pk_id, n.palavra_chave, n.texto, n.titulo, n.sub_titulo, n.data_postagem, n.imagem, g.tipo_genero
                FROM noticia n
                INNER JOIN generos g ON n.fk_generos = g.pk_id
    ...
    if($method=="POST"){
        ...
        try {
            ...
            if(empty($dados->fk_generos) ){
                // está vazio  : ERRO
                throw new ErrorException("Valor da Generos é inválido", 1);
            }
